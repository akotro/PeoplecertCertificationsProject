...
namespace Assignment4Final.Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                columns: table =>
                    new
                    {
                        Id = table
                            .Column<int>(type: "int", nullable: false)
                            .Annotation("SqlServer:Identity", "1, 1"),
                        CountryOfResidence = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: true
                        )
                    },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        CandidateNumber = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: true
                        ),
                        PhotoIdNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                        PhotoIdIssueDate = table.Column<DateTime>(
                            type: "datetime2",
                            nullable: true
                        ),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey(
                        "PK_CertificateTopic",
                        x => new { x.CertificatesId, x.TopicsId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        AssessmentCode = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: true
                        ),
                        CandidateId = table.Column<string>(type: "nvarchar(450)", nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "CandidateExamAnswers");

            migrationBuilder.DropTable(name: "CertificateTopic");

            migrationBuilder.DropTable(name: "DeviceCodes");

            migrationBuilder.DropTable(name: "ExamQuestion");
            ...
            migrationBuilder.DropTable(name: "CandidateExams");
            ...
            migrationBuilder.DropTable(name: "DifficultyLevels");
            ...
            migrationBuilder.DropTable(name: "PhotoIdTypes");
