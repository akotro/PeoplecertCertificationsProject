        ...
        public static void SeedStandaloneTables(ApplicationDbContext db)
        {
            ...
            if (!db.Users.Any())
            {
                ...
                for (int i = 0; i < fakeGuids.Count; i++)
                {
                    ...
                    fakeAppUsers[i].PasswordHash = passHash.HashPassword(fakeAppUsers[i], $"Admin{i}!");
                }
            ...
            if (!db.Genders.Any())
            {
                ...
                {
                    genderEntries.Add(new Gender
                    {
                        GenderType = (GenderEnum)value
                    });
                }
            ...
            if (!db.DifficultyLevels.Any())
            {
                ...
                {
                    difficultyLevelEntries.Add(new DifficultyLevel
                    {
            ...
            if (!db.Exams.Any())
            {
                ...
                var examFaker = new Faker<Exam>()
                    .RuleFor(c => c.Certificate, f => f.PickRandom(db.Certificates.ToList()));
        ...
        public static void SeedRelatedTables(ApplicationDbContext db)
        {
            ...
            if (!db.CandidateExams.Any())
            {
                var candiExamAnsFaker = new Faker<CandidateExamAnswers>()
                    .RuleFor(c => c.ChosenOption, f => f.PickRandom(db.Options.ToList()).Text.ToString())
                    .RuleFor(c => c.CorrectOption, f => f.PickRandom(db.Options.ToList()).Text.ToString())
                ...
                var candiExamFaker = new Faker<CandidateExam>()
                    ...
                    .RuleFor(c => c.CandidateExamAnswers, f =>
                    {
